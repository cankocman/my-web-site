            ...
            <div className="col-md-6 m-15px-tb blog-list-item">
              <div className="blog-grid">
                ...
                <div className="blog-info">
                  ...
                  <h6>
                    <Link legacyBehavior href="/single-blog">
                      <a>I Will Tell You The Truth About Design In The Next 60 Seconds.</a>
                    </Link>
                  </h6>
                </div>
              </div>
            ...
            <div className="col-md-6 m-15px-tb blog-list-item">
              <div className="blog-grid">
                ...
                <div className="blog-info">
                  ...
                  <h6>
                    <Link legacyBehavior href="/single-blog">
                      <a>10 Things You Most Likely {`Didn't`} Know About Design.</a>
                    </Link>
                  </h6>
                </div>
              </div>
            ...
            <div className="col-md-6 m-15px-tb blog-list-item">
              <div className="blog-grid">
                ...
                <div className="blog-info">
                  ...
                  <h6>
                    <Link legacyBehavior href="/single-blog">
                      <a>Why swiming is also another important thing for man.</a>
                    </Link>
                  </h6>
                </div>
              </div>
            ...
            <div className="col-md-6 m-15px-tb blog-list-item">
              <div className="blog-grid">
                ...
                <div className="blog-info">
                  ...
                  <h6>
                    <Link legacyBehavior href="/single-blog">
                      <a>What You Know About Design And What You {`Don't`} Know About Design.</a>
                    </Link>
                  </h6>
                </div>
              </div>
